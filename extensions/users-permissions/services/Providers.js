  ...
  switch (provider) {
    ...
    case 'google': {
      ...
      google
        .query('oauth')
        .get('tokeninfo')
        // this is the only difference from the default google provider from strapi, 
        // we'll be passing id_token rather than access_token similar to what's described here: 
